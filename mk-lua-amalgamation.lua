...
local ucpp_prefix = "/home/mingo/dev/c/A_programming-languages/uccp-s/"
local ucpp = [==[
assert.c
eval.c
lexer.c
...
print('#ifdef WITH_LSQLITE3')
setIncluded({"sqlite3.h"})
print('#include "sqlite3.h"')
print('#define dblib dblib_sqlite3')
CopyWithInline("/home/mingo/dev/lua/lsqlite3/lua/", "lsqlite3.c");
print('#undef dblib_sqlite3')
print('#endif //WITH_LSQLITE3')
...
print('#ifdef WITH_UCPP')
print('#define main ucpp_main')
print('#define usage ucpp_usage')
print('#undef COMMENT')
for filename in ucpp:gmatch('([^\n]+)') do
	CopyWithInline(ucpp_prefix, filename);
end
print('#undef main')
print('#undef usage')
print('#endif //WITH_UCPP')
print('#ifdef MAKE_LUA_WASM')
CopyWithInline("./", "cgsql-lua-playground.c")
print([==[
